...
const Search = ({
  ...
  function handleSearch() {
    ...
    const searchResults = centres.filter(item => {
      if (duplicatedButton && item.centreCity !== duplicatedButton) {
        return false;
      }
      
      // if (duplicatedButton2 && item.city !== duplicatedButton2) {
      //   return false;
      // }
      
      // if (duplicatedButton3 && item.city !== duplicatedButton3) {
      //   return false;
      // }
