    ...
    <div>
      <div className="SearchBar">
        <div style={{marginLeft:10}} className="locationBtn">
          <p style={{fontSize:15}}>Anywhere</p>
        </div>
        <div>
          <div className="weekBtn">
            <p style={{fontSize:15}}>Any Week</p>{" "}
          </div>
        </div>
        <div className="guestBtn">
<<<<<<< HEAD:reservnow/components/Header/Search.jsx
          <p style={{fontSize:15}}>Add guests</p>
=======
          <p style={{color: '#717171'}}>Add guests</p>
>>>>>>> c3241411c3d80ddec0fd594ec233c68ec96cf162:reservnow/components/Search/Search.jsx
        </div>
