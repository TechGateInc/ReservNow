      ...
      <div className={styles["host-container"]}>
        ...
        <div className={styles["pagefooter-section"]}>
          <div className={styles["loader-background"]}>
            <div
              className={`${styles["page-loader"]} ${active === "Overview"
          ...
          <div className={styles["host-footer"]}>
            ...
            {active === "UploadGallery" && (
              <button
                ...
                className={`${styles["next-btn"]} ${isSubmitDisabled ? styles["disabled"] : ""
                  }`}
...
const ProtectedHostAnEventCentrePage = () => {
  return (
    <PersistLogin>
      <RequireAuth>
        <HostAnEventCentrePage />
      </RequireAuth>
    </PersistLogin>
  );
};
...
export default ProtectedHostAnEventCentrePage