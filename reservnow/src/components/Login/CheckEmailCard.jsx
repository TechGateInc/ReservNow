...
import { useGetEmailVerificationMutation } from "@/src/api/features/email verification/emailVerify";
...
export default function CheckEmailCard(props) {
  ...
  const [getEmailVerification, { isLoading }] =
            ...
            <div className={styles["email-modal-content"]}>
              ...
              <div className={styles["email-modal-form"]}>
                ...
                <p>
                  ...
                  message and data rates apply. Privacy Policy and Terms of
                  Service
                </p>
              ...
              <div className={styles["email-options-cont"]}>
                ...
                <div
                  className={styles["email-options"]}
