...
const Search = ({
  ...
  return (
    <div className="SearchBar">
      <div
        className="extend-button locationBtn"
        onClick={() => extendToggle("location")}
      >
        {location ? (
          <div>
            <p
      ...
      <div>
        <div
          className="weekBtn extend-button"
          onClick={() => extendToggle("ctype")}
        >
          {ctype ? (
            <div>
              <p
      ...
      <div
        className="guestBtn extend-button"
        onClick={() => dropdownToggle("capacity")}
      >
        {capacity ? (
          <div>
            <p
      ...
      <div
        className="searchBtn"
        style={{ cursor: submitButtonDisabled ? "not-allowed" : "pointer1" }}
      >
        <img
